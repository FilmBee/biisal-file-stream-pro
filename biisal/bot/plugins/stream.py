...
🔻 𝗙𝗔𝗦𝗧 𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗 ▶ <a href="{}">ᴄʟɪᴄᴋ ʜᴇʀᴇ</a>
🔺 𝗪𝗔𝗧𝗖𝗛 𝗢𝗡𝗟𝗜𝗡𝗘 ▶ <a href="{}">ᴄʟɪᴄᴋ ʜᴇʀᴇ</a>

‣ ʟɪɴᴋ ɢᴇɴᴇʀᴀᴛᴇᴅ ʙʏ: ᴅᴇᴠᴇɪᴛʜᴏɴ 😎"""
    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            if user.status == "kicked":
                await c.send_message(
                    chat_id=m.chat.id,
                    text="You are banned!\n\n  **Cᴏɴᴛᴀᴄᴛ Support [Support](https://t.me/DevEithon) They Wɪʟʟ Hᴇʟᴘ Yᴏᴜ**",
            ...
            await c.send_message(
                chat_id=m.chat.id,
                text="**Sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ Wʀᴏɴɢ. Cᴏɴᴛᴀᴄᴛ ᴍʏ Support** [Support](https://t.me/DevEithon)",
